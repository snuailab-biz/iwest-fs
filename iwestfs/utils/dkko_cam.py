...
class AsyncCamera:
    ...
    def __init__(self,url, camera_infos:list=[], COLOR = "BGR"):
        ...
        self.caption_list, self.cropbox_list, self.event_list, self.name_list = \
            zip(*[(caption, [x1, y1, x2, y2], event, name) \
                  for name, x1, y1, x2, y2, caption, event in camera_infos])

        self.data_num = len(camera_infos);
