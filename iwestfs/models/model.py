import sys
import torch
from iwestfs.models.backbone import Backbone
from iwestfs.models.position_encoding import PositionEmbeddingSine
from iwestfs.models.backbone import Joiner
from iwestfs.models.mdef_detr.deformable_transformer \
    import DeformableTransformer as MDefDETRTransformer
from iwestfs.models.mdef_detr_minus_language.deformable_transformer \
    import DeformableTransformer as MDefDETRMinusLanguageTransformer
from iwestfs.models.mdef_detr.mdef_detr import MDefDETR
from iwestfs.models.mdef_detr_minus_language.mdef_detr_minus_language import MDefDETRMinusLanguage
...
class Model:
    ...
    def __init__(self, name, checkpoints_path=None):
        ...
        if name == "mdef_detr":
            ...
            from iwestfs.models.inference.modulated_detection import ModulatedDetection as Inference
        elif name == "mdef_detr_minus_language":
            assert checkpoints_path is not None
            model = _make_mdef_detr_minus_language(checkpoints_path)
            from iwestfs.models.inference.minus_language import MinusLanguage as Inference
        else:
